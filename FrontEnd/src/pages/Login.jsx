...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center bg-cover py-12 sm:px-6 lg:px-8"
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <button 
              ...
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white
               bg-emerald-900 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              LogIn
            </button>
          </form>
